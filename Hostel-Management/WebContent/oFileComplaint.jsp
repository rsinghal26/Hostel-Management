...
<br>
	...
	<%
    	...
    	db3.connect(); 
    	String sql = "SELECT * FROM FilesComplaint where applicant_id ='"+ session.getAttribute("rollNo") +"'";
    	ResultSet rs = db3.Query(sql);	
    ...
    <fieldset>
	<h1 style="text-align:center">Complaint Applications</h1>
	<table>
  <tr>
    <th>Complaint Id</th>
    <th>Category</th>
