...
<body>
	<div class="navbar">
		...
		<a href="AdminLeave.jsp" class="active">Leave Applications</a>
	...
	<%
    	...
    	db.connect(); 
    	String sql = "SELECT * FROM leaveapplication where status = 1";
	...
	<%while(rs.next()){
		...
		Date fromDate = rs.getDate("from_");
		Date toDate = rs.getDate("to_");
		String reason = rs.getString("reason"); %>
    	<fieldset style="margin-left:10px;margin-right:10px;">
    		<label for="applicationId"><b>Application Id:</b></label>
            <span><%=applicationId %></span><br><br>
            <label for="applicantId"><b>Applicant Id:</b></label>
            <span><%=applicantId%></span>
            <label for="requestedOn"><b>Requested On:</b></label>
            <span><%=date %></span><br><br>
            <label for="fromDate"><b>Leave From:</b></label>
            <span><%=fromDate%></span>
            <label for="toDate"><b>Leave To:</b></label>
            ...
            <div class="buttonBox">
            	<form action="acceptApplication" method='POST'>
          			...
          			<input value="leaveapplication" name="appType" style="display:none">
