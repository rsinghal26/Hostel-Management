...
<body>
	<div class="navbar">
		...
		<a href="AdminFileComplaints.jsp" class="active">Complaints Applications</a>
	...
	<%
    	...
    	db.connect();
    	db2.connect();
    	String sql = "SELECT * FROM FilesComplaint where status = 1";
	...
	<div style="margin-top:20px;padding:10px;">
		<%while(rs.next()){
			...
			String reason = rs.getString("details"); 
			
			ResultSet rsp = db2.Query("SELECT * from Complaint where categoryID = "+ categoryId);
			rsp.next();
			String category = rsp.getString("categoryName");
			%>
    	...
    	<fieldset>
            ...
            <label for="date"><b>Date of Application:</b></label>
            <span><%=date %></span>
            <label for="category"><b>Category:</b></label>
            <span><%=category %></span><br><br>
            <label for="reason"><b>Detail:</b></label>
            <span><%=reason %></span>
            <div class="buttonBox">
            	<form action="acceptApplication" method='POST'>
          			...
          			<input value="FilesComplaint" name="appType" style="display:none">
