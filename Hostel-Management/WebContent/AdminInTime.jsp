...
<body>
	<div class="navbar">
		...
		<a href="AdminInTime.jsp" class="active">In-Time Applications</a> 
	...
	<%
    	...
    	db.connect(); 
    	String sql = "SELECT * FROM InTimeApplication where status = 1";
	...
	<div style="margin-top:20px;padding:10px;">
		<%	while(rs.next()){
			...
			String facultyMentor = rs.getString("facultyMentor");
		%>
    	<fieldset>
            ...
            <div class="buttonBox">
            	<form action="acceptApplication" method='POST'>
          			...
          			<input value="intimeapplication" name="appType" style="display:none">
